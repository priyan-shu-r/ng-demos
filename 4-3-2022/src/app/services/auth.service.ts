...
export class AuthService {
  ...
  login({ email, password }: any): Observable<any> {
    if(email === 'admin@gmail.com' && password === 'Admin@12') {
      ...
      return of({ name:'Priyanshu', email:'admin@gmail.com'});  //returning obserable variable
    }
    ...
    return throwError(new Error('Failed to login: Please enter valid email and password'));
  }
}
